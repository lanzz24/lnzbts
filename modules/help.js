...
async function mainF(text) {
    ...
    if (text == "!help") {
        ...
        if (param == "pmpermit") {
            ...
            return `*Zee5*\n\nStream all content of fadhlanz for free with this module. \n\n*!zee5 [Particular-Episode/Movie-Link]*\n to Stream`
        } else if (param == "qr") {
